...
// according to the JSON string escaping rules.
package jsonstring
...
// WriteQuotedString writes s surrounded by quotes and escaped according to
// JSON escaping rules to w.
...
// WriteQuotedBytes writes s surrounded by quotes and escaped according to
// JSON escaping rules to w.
...
// UnquoteBytes returns s with the surrounding quotes removed and JSON escape
// sequences replaced with their UTF-8 encoding.
